...
public class OpisFragment extends ListFragment implements Updater {
    private FragmentsCallbacks mCallbacks;
    private OpisAdapter adapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        List<Opis> list = Api.getInstance().getListOpis();
        adapter = new OpisAdapter(getActivity(), list);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        // action_edit
        Opis opis = (Opis) l.getItemAtPosition(position);
        showDetail(opis);
    }

    private void showDetail(Opis opis) {
        if (null != mCallbacks) {
            mCallbacks.onCallForDetail(opis);
        }
    }
