...
public class Tooltip extends ViewGroup {
    // Most of these could/should be settable.
    private static final int TEXT_SIZE_SP = 10;
    private static final int ARROW_SIDE_SIZE_DP = 10;
    private static final int ROUNDED_CORNERS_RADII_DP = 6;
    ...
    private int mColor = getResources().getColor(R.color.tooltip_color);
    ...
    public void show() {
        ...
        // Configure the views here instead of having the values read from super (this).
    ...
    /**
     * Set the text1 that appears in the tooltip.
     */
